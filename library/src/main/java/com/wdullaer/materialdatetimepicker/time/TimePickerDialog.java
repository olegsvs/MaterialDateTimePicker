...
public class TimePickerDialog extends DialogFragment implements
    ...
    private int mSelectionGradientStart = -1;
    private int mSelectionGradientEnd = -1;
    ...
    /**
     * Set the background drawable of this dialog
     *
     * @param drawable the background drawable you want
     */
    ...
    public void setSelectionGradientColors(int colorStart, int colorEnd) {
        mSelectionGradientStart = colorStart;
        mSelectionGradientEnd = colorEnd;
    }

    @Override
    public int getmSelectionGradientStart() {
        return mSelectionGradientStart;
    }

    @Override
    public int getmSelectionGradientEnd() {
        return mSelectionGradientEnd;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if (mBackgroundDrawable == -1)
            view.findViewById(R.id.mdtp_time_display).setBackgroundColor(mAccentColor);
        else
            view.findViewById(R.id.mdtp_time_display).setBackgroundResource(mBackgroundDrawable);
